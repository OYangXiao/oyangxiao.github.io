...
<img width="300" src="/assets/img/pexels/mindmap/mindmup/simple.jpg" />
...
开源地址在[mapjs](https://github.com/mindmup/mapjs/)，该仓库中给出了详细的使用样例代码，不做开发直接拿来用的话会比百度脑图更加完善易用。但是这个库没有类似于 kity 这样的底层 svg 封装库，导致代码量较大，花了好几天时间依然难以理清头绪，二次开发难度较大。

***相对而言，mindmup 开发上手难度大，但是可操作性比较高，能够应付客户的各种需求，百度脑图虽然刚开始开发较为简单，但是遇到难以解决的问题，就需要再去修改底层的 kity 库，很难说到底是用哪种方案比较好。***
